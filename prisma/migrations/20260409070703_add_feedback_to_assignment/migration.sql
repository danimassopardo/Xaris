...
INSERT INTO "new_Assignment" ("createdAt", "description", "dueDate", "gradeValue", "id", "status", "studentId", "subjectId", "title", "type", "updatedAt") SELECT "createdAt", "description", "dueDate", "gradeValue", "id", "status", "studentId", "subjectId", "title", "type", "updatedAt" FROM "Assignment";
