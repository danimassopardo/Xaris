  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>Importar Estudiantes CSV</DialogTitle>
        </DialogHeader>
        <div className="space-y-3">
          <p className="text-xs text-[var(--muted-foreground)]">
            Columnas requeridas: <code>name, studentId, course</code>. Opcionales:{" "}
            <code>notes</code>
          </p>
          <div className="space-y-1">
            ...
            <Textarea
              ...
              placeholder={"name,studentId,course,notes\nAlice Johnson,S001,Science,Notas..."}
              rows={6}
          ...
          {result && (
            <div className="text-sm">
              <p className="text-green-600">✅ {result.imported} estudiantes importados</p>
